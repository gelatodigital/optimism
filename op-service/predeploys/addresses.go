...
const (
	...
	L2PriceOracle                 = "0x4200000000000000000000000000000000000420"
...
var (
	...
	L2PriceOracleAddr                 = common.HexToAddress(L2PriceOracle)
...
func init() {
	...
	Predeploys["L2PriceOracle"] = &Predeploy{Address: L2PriceOracleAddr}
