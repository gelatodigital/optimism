...
library Predeploys {
    ...
    /// @notice Address of the L2PriceOracle predeploy.
    address internal constant L2_PRICE_ORACLE = 0x4200000000000000000000000000000000000420;
    ...
    function getName(address _addr) internal pure returns (string memory out_) {
        ...
        if (_addr == L2_PRICE_ORACLE) return "L2PriceOracle";
